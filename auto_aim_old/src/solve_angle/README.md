...
本模块基于 [transport_drivers](https://github.com/ros-drivers/transport_drivers) 实现了 [auto_aim](https://github.com/chenjunnn/auto_aim) 项目与电控部分通讯的功能，也可作为使用 ros2 作为开发框架的参赛队的串口通讯模块参考
...
启动串口模块 `ros2 launch jlcv_serial_driver serial_driver.launch.py`

## 发送和接收

详情请参考 [packet.hpp](include/jlcv_serial_driver/packet.hpp)
